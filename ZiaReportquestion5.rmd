...
```{r}
with(Ziadata, cor.test(Air.Temp..C, 
  Scorpion.distance.from.vegetation.cm, alternative="two.sided", 
  method="pearson"))
```
...
```{r}
with(Ziadata, cor.test(rH..ground, 
  Scorpion.distance.from.vegetation.cm, alternative="two.sided", 
  method="pearson"))
```

```{r}
with(Ziadata, cor.test(Scorpion.distance.from.vegetation.cm, 
  Soil.Temp..C, alternative="two.sided", method="pearson"))
```
## Inferential Results
